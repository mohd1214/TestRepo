...
@ManagedBean(name = "CoreProcessTaskView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CoreProcessTaskView", beanType = BeanType.PORTLET)
public class CoreProcessTaskView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
