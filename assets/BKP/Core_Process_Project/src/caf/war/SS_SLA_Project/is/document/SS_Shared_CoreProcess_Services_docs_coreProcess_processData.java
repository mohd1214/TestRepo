...
public  class SS_Shared_CoreProcess_Services_docs_coreProcess_processData extends java.lang.Object implements Serializable {
	...
	public static String[][] FIELD_NAMES = new String[][] {{"processType", "processType"},{"currentStep", "currentStep"},{"bpmstepdetails", "BPMStepDetails"},{"errorDoc", "errorDoc"},{"isThereNextApprover", "isThereNextApprover"},{"isNextApproverMandatoryAndNotFound", "isNextApproverMandatoryAndNotFound"},{"isFirstStep", "isFirstStep"},{"skipTask", "skipTask"},
	};
