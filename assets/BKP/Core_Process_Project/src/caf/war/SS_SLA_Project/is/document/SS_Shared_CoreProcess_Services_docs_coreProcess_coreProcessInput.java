...
public  class SS_Shared_CoreProcess_Services_docs_coreProcess_coreProcessInput extends java.lang.Object implements Serializable {
	...
	public static String[][] FIELD_NAMES = new String[][] {{"headerFields", "HeaderFields"},{"requestData", "RequestData"},{"requesterData", "RequesterData"},{"approvalStepsDetails", "ApprovalStepsDetails"},{"targetStepData", "TargetStepData"},
	};
