...
public  class SS_Shared_CoreProcess_Services_docs_coreProcess_approvalStepsDetails extends java.lang.Object implements Serializable {
	...
	public static String[][] FIELD_NAMES = new String[][] {{"ownerEmail", "ownerEmail"},{"actorEmail", "actorEmail"},{"action", "action"},{"stepName", "stepName"},{"taskId", "taskId"},{"requestStepId", "requestStepId"},{"wfSteps", "wfSteps"},{"sla", "SLA"},{"sla_checkpoint", "SLA_checkpoint"},{"sla_date", "SLA_date"},{"stepFields", "stepFields"},
	};
