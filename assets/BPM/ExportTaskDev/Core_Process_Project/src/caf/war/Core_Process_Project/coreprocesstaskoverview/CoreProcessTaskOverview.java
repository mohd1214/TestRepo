...
@ManagedBean(name = "CoreProcessTaskOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "CoreProcessTaskOverview", beanType = BeanType.PORTLET)
public class CoreProcessTaskOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.Core_Process_Project.Core_Process_Project core_Process_Project = null;
	/**
	 ...
	 */
	public CoreProcessTaskOverview() {
	...
	public caf.war.Core_Process_Project.Core_Process_Project getCore_Process_Project()  {
		if (core_Process_Project == null) {
		    core_Process_Project = (caf.war.Core_Process_Project.Core_Process_Project)resolveExpression("#{Core_Process_Project}");
		}
		return core_Process_Project;
	}
