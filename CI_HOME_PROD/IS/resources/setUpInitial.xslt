...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:param name="isPackagesToBuild"/>
	...
	<xsl:template match="DeployerSpec/Projects">
		<Projects>
			...
			<xsl:attribute name="description">[<xsl:value-of select="$dateTime"/>] [<xsl:value-of select="$comment"/>] [<xsl:value-of select="$isPackagesToBuild"/>] => <xsl:value-of select="$isPackagesString"/></xsl:attribute>
